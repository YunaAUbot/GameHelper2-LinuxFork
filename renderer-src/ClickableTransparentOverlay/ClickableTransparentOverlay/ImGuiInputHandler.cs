namespace ClickableTransparentOverlay
{
    ...
    internal class ImGuiInputHandler
    {
        ...
        public bool Update(bool preserveNativeInput = false)
        {
            var io = ImGui.GetIO();
            ...
            if (!preserveNativeInput && !io.WantCaptureMouse && ImGui.IsAnyMouseDown())
            {
        ...
        private static bool TryMapNativeKey(uint key, out ImGuiKey result)
        {
            result = key switch
            {
                0xff09 => ImGuiKey.Tab, 0xff0d => ImGuiKey.Enter, 0xff1b => ImGuiKey.Escape,
                0xff08 => ImGuiKey.Backspace, 0xffff => ImGuiKey.Delete, 0xff63 => ImGuiKey.Insert,
                0xff50 => ImGuiKey.Home, 0xff57 => ImGuiKey.End, 0xff55 => ImGuiKey.PageUp,
                0xff56 => ImGuiKey.PageDown, 0xff51 => ImGuiKey.LeftArrow, 0xff52 => ImGuiKey.UpArrow,
                0xff53 => ImGuiKey.RightArrow, 0xff54 => ImGuiKey.DownArrow,
                0xffe1 or 0xffe2 => ImGuiKey.ModShift, 0xffe3 or 0xffe4 => ImGuiKey.ModCtrl,
                0xffe9 or 0xffea => ImGuiKey.ModAlt, 0xffeb or 0xffec => ImGuiKey.ModSuper,
                >= 0xffbe and <= 0xffc9 => ImGuiKey.F1 + (int)(key - 0xffbe),
                _ => ImGuiKey.None,
            };
